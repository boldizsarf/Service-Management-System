...
$end = $year . "-01-31";
$avgArray1[] = null;
$dbdata = $dbc->get("SELECT * FROM cases WHERE type=? AND created BETWEEN ? AND ?", ["warranty", $start, $end]);
