...
$start = $year . "-01-01";
$end = $year . "-01-31";
$dbdata = $dbc->get("SELECT * FROM pcases WHERE branch=? AND submitdate BETWEEN ? AND ?", ["warranty", $start, $end]);
echo count($dbdata) . ",";
?>
...
$start = $year . "-01-01";
$end = $year . "-01-31";
$dbdata = $dbc->get("SELECT * FROM pcases WHERE branch=? AND submitdate BETWEEN ? AND ?", ["rejected", $start, $end]);
echo count($dbdata) . ",";
?>
...
$start = $year . "-01-01";
$end = $year . "-01-31";
$dbdata = $dbc->get("SELECT * FROM pcases WHERE branch=? AND submitdate BETWEEN ? AND ?", ["nff", $start, $end]);
echo count($dbdata) . ",";
?>
...
$start = $year . "-01-01";
$end = $year . "-01-31";
$dbdata = $dbc->get("SELECT * FROM pcases WHERE branch=? AND submitdate BETWEEN ? AND ?", ["doa", $start, $end]);
echo count($dbdata) . ",";
?>
