...
if ($role != 0) {
    echo '<meta http-equiv="refresh" content="0; URL=/dashboard/device/' . $param[3] . '">';
    return;
}
...
<section class="section">
    <div class="section-header">
        ...
        <div class="section-header-breadcrumb">
            <a href="/dashboard/activate/<?php echo $device["id"]; ?>" class="btn btn-icon icon-left btn-primary"><i class="fas fa-plus"></i> Szolgáltatás aktiválása</a>
        </div>
    </div>
