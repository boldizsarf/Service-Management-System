                            ...
                            if ($dbstatus6[0]["date"] == null) {
                                if (isset($dbstatus1[0]["date"])) {
                                    if ($statuscolor != "text-success") {
                                        ...
                                        $dbnotify = $dbc->get("SELECT * FROM notifications WHERE uid=? AND url LIKE ? AND viewed=?", [$uid, "%" . "/case/" . $case["id"] . "%", "0"]);
                                        if (isset($dbnotify[0]["id"])) {
                                            $noticon = ' <a href="/dashboard/notify/' . $dbnotify[0]["id"] . '"><i class="fas fa-envelope"></i></a>';
                                        } else {
                                            $noticon = '';
                                        }
                                        ...
                                        echo "                    <td data-order=\"" . $days . "\">" . $lejarat . $noticon . "</td>\n";
                                        echo "                    <td>" . $cuser . "</td>\n";
