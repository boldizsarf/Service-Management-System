                ...
                <div class="col-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <h6><?php echo $lang->serial; ?>: <span class="text-primary mb-2"><a href="/dashboard/eds/<?php echo $device["id"]; ?>"><?php echo $device["serial"]; ?></a></span></h6>
                            <h6><?php echo $lang->distributor; ?>: <?php
                            ...
                            <h6>Tulajdonos: <span class="text-primary mb-2"><a href="/dashboard/user/<?php echo $duser["id"]; ?>"><?php echo $duser["lastname"] . " " . $duser["firstname"]; ?></a></span></h6>
                        </div>
                    </div>
                </div>
                <div class="col-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <table class="table table-sm">
                                ...
                                <tbody>
                                <?php
                                $dbaccessory = $dbc->get("SELECT * FROM accessories WHERE did=?", [$param[3]]);
                                foreach ($dbaccessory as $accessory) {
                                    echo "<tr>";
                                    echo "<td>" . $accessory["type"] . "</td>";
                                    echo "<td><a href='/dashboard/eas/" . $accessory["id"] . "'>" . $accessory["serial"] . "</a></td>";
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <table class="table">
                                ...
                                <tbody>
                                <?php
                                $dbcase = $dbc->get("SELECT * FROM cases WHERE device=? ORDER BY id DESC", [$param[3]]);
                                ...
                                foreach ($dbcase as $case) {
                                    ...
                                    echo "<td><a href='/dashboard/case/" . $case["id"] . "' class=\"btn btn-primary\">" . $lang->show . "</a></td>";
                                    echo "                </tr>";
