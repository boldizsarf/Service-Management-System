...
<div class="tab-pane fade" id="viewinspection" role="tabpanel" aria-labelledby="viewinspection-casetabs">
        ...
        <div class="row" <?php if (is_dir("db/caseimages/" . $case["id"]) == false) { echo "hidden"; } ?>>
            <div class="col-12">
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        <div id="gallery" class="gallery gallery-md">
                            <?php
    ...
    <div class="row">
        <div class="col-12">
            <div class="card card-primary" <?php if ($dbinspection[0]["accepted"] != null) { echo "hidden"; } ?>>
                <div class="card-header">
                    <h4><?php echo $lang->acceptibill; ?></h4>
                </div>
                <div class="card-body">
                    <form method="post" action="/dashboard/mycase/<?php echo $case["id"]; ?>/billaction/">
                        <div class="form-group">
                            <label class="form-label">Elfogadja az árajánlatot?<span class="text-primary mb-2">*</span></label>
                            <div class="selectgroup selectgroup-pills">
                                <label class="selectgroup-item">
                                    <input type="radio" name="accepted" id="accepted" value="1" class="selectgroup-input" checked="">
                                    <span class="selectgroup-button"><i class="fas fa-check"></i> <?php echo $lang->yes; ?></span>
                                </label>
                                <label class="selectgroup-item">
                                    <input type="radio" name="accepted" id="accepted" value="0" class="selectgroup-input">
                                    <span class="selectgroup-button"><i class="fas fa-times"></i> <?php echo $lang->no; ?></span>
                                </label>
                            </div>
                            <small class="form-text text-muted">
                                Amennyiben elutasítja, kérjük írja le az elutasítás okát.
                            </small>
                        </div>
                        <div class="form-group">
                            <label class="form-label">Megjegyzés</label>
                            <textarea name="acceptnote" id="acceptnote" rows="10" cols="80"></textarea>
                            <script>
                                CKEDITOR.replace( 'acceptnote' );
                            </script>
                        </div>
                        <input type="text" class="form-control" name="iid" id="iid" value="<?php echo $dbinspection[0]["id"]; ?>" hidden>
                        <div class="form-group">
