                ...
                <form method="POST" action="/backend/addcase.php">
                    ...
                    <div class="row">
                        <div class="form-group col-12">
                            ...
                            <select class="form-control select2" name="device" id="device" required>
                                ...
                                $uid = $dbuser[0]["id"];
                                if ($dbuser[0]["role"] == "0" || $dbuser[0]["role"] == "20") {
                    ...
                    <div class="row">
                        <div class="form-group col-12">
                            ...
                            <div class="selectgroup selectgroup-pills">
                                <label class="selectgroup-item">
                                    <input onclick="dmodeCheck()" type="radio" name="takeover" id="courier" value="courier" class="selectgroup-input" checked="">
                                    <span class="selectgroup-button"><i class="fas fa-truck"></i> Door-to-Door</span>
                                </label>
                                <label class="selectgroup-item" hidden>
                                    <input onclick="dmodeCheck()" type="radio" name="takeover" id="duplitec" value="duplitec" class="selectgroup-input">
                                    <span class="selectgroup-button"><i class="fas fa-warehouse"></i> Személyesen az MDS szervizközpontban</span>
                                </label>
                            </div>
                        </div>
