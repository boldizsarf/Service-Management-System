<?php
$dbinspection = $dbc->get("SELECT * FROM pquote WHERE pcid=? ORDER BY id DESC", [$case["CaseID"]]);
?>
<div class="card">
    <div class="card-header">
        <h4>Árajánlat kiadása</h4>
    </div>
    <div class="card-body">
        <form id="inspectform" method="POST" action="/backend/pcaseman.php?q=addquote" enctype="multipart/form-data">
            <div class="row">
            ...
            <div class="row">
                <div class="form-group col-12">
                    <label>Munkaóra típusa</label>
                    <select class="form-control select2" style="width: 100% !important;" name="workhour" id="workhour" required>
                        <option value="7795">Consumer - nettó 7.795Ft /óra</option>
                        <option value="11732">Pro - nettó 11.732Ft /óra</option>
                        <option value="15669">Enterprise - nettó 15.669Ft /óra</option>
                    </select>
                </div>
            </div>
            ...
            <script type="text/javascript">
                ...
                var loop = setInterval(function(){
                    ...
                    whnt = document.getElementById("workhours").value*document.getElementById("workhour").value;
                    pricent = whnt + sum;
                ...
                <div class="form-group col-12">
                    ...
                    <table class="table" id="partlistTable">
                        ...
                        if (isset($dbinspection[0]["id"])) {
                            $dbparts = $dbc->get("SELECT * FROM qparts WHERE qid=? ORDER BY id ASC", [$dbinspection[0]["id"]]);
                            if (isset($dbparts[0]["id"])) {
                                foreach ($dbparts as $part) {
                                    ...
                                    echo "<td><input name=\"ar[]\" id='ar' type=\"text\" class=\"form-control\" value='" . $part["pricent"] . "'></td>";
            ...
            <input name="trackingid" id="trackingid" value="<?php echo $param[3]?>" type="text" class="form-control" hidden>
            <input name="pcid" id="pcid" value="<?php echo $case["CaseID"]?>" type="number" class="form-control" hidden>
            ...
            <div class="row">
                <div class="form-group col-4">
                    <label class="form-label">Végösszeg</label>
